...
<div class="w3-row-padding w3-light-grey w3-padding-64 w3-container">
  <div class="w3-content">
    <div class="w3-third w3-center">
      ...
      <img class="w3-padding-64 w3-text-red w3-margin-right" src="https://cdn.freebiesupply.com/logos/large/2x/spider-man-3-logo-png-transparent.png" width=400 height=500>
    </div>
